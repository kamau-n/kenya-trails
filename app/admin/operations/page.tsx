...
const OperationsDashboard = () => {
  ...
  const handlePaymentVerification = async (e) => {
    ...
    try {
      const response = await fetch(
        `/api/paystack/payments/confirm/${paymentReference}`
      );
      const data = await response.json();
  ...
  const selectedBank = banks.find(
    (bank) => bank?.code === withdrawalForm?.bankCode
  );
        ...
        <div className="bg-white rounded-lg shadow-sm border">
          <div className="p-6 border-b">
            ...
            <p className="text-gray-600 mt-1">
              Manage withdrawals and verify payments
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <div className="space-y-1 text-sm text-gray-600">
                ...
                <p>
                  • POST /api/paystack/initiate-transfer - Initiate transfer
                </p>
              </div>
            </div>
          ...
          <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-md">
            <div className="flex items-start space-x-2">
              ...
              <div className="text-sm text-yellow-800">
                ...
                <p>
                  Make sure you have the required API endpoints implemented on
                  your backend for withdrawals to work properly. The payment
                  verification uses your existing endpoint.
                </p>
              </div>
            </div>
          </div>
