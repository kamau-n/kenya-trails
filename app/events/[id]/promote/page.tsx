  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="md:px-12 mx-auto px-4 py-12 lg:py-16">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
              Boost Your Event's Reach
            </h1>
            <p className="text-lg md:text-xl opacity-90 mb-6">
              Choose the perfect promotion package to get your event in front of
              thousands of potential attendees
            </p>
            {event && (
      ...
      {/* Main Content */}
      <div className="md:px-12 mx-auto px-4 py-8 lg:py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {promotions.map((promotion, index) => (
              <Card
                ...
                onClick={() =>
                  !processingPayment && handlePromotionSelect(promotion)
                }>
                {/* Popular Badge */}
                {index === 1 && (
                ...
                <CardHeader className="text-center pb-4">
                  {/* Icon */}
                  <div
                    className={`w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r ${getPromotionColor(
                      index
                  ...
                  <div className="flex items-center justify-center text-gray-600">
                    ...
                    <span className="text-sm">
                      {promotion.duration} days promotion
                    </span>
                  </div>
                </CardHeader>
                  ...
                  <Button
                    className={`w-full mt-6 ${
                      selectedPromotion?.id === promotion.id
                        ...
                        : `bg-gradient-to-r ${getPromotionColor(
                            index
                          )} hover:opacity-90`
                    } text-white`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Get your event in front of our active community of event-goers
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Increase your event attendance by up to 300% with our
                  promotion
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Get featured in prime spots across our platform and
                  newsletters
                </p>
              </div>
            </div>
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle className="flex items-center">
              <div
                className={`w-8 h-8 rounded-full bg-gradient-to-r ${getPromotionColor(
                  promotions.findIndex((p) => p.id === selectedPromotion?.id)
            ...
            <DialogDescription>
              ...
              <strong>{selectedPromotion?.name}</strong> package for{" "}
              <strong>KES {selectedPromotion?.price}</strong>
            </DialogDescription>
          </DialogHeader>
