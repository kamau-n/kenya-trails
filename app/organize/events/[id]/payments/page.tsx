  ...
  const downloadAllBookings = async () => {
    ...
    try {
      ...
      const renderHeader = () => {
        ...
        if (logoBase64) {
          doc.addImage(logoBase64, "PNG", pageWidth - 40, 10, 20, 15);
        }

        doc.setTextColor(255, 255, 255);
        doc.setFontSize(20);
        doc.setFont("helvetica", "bold");
        doc.text("Kenya Trails - " + (event?.title || "Event"), 20, 20);
      ...
      const renderTableHeader = () => {
        ...
        doc.setFillColor(22, 101, 52); // same as your header
        doc.setTextColor(255, 255, 255); // white text

        doc.rect(20, yPosition - 5, pageWidth - 40, 10, "F");

        doc.text("Customer", 22, yPosition);
        doc.text("Date", 65, yPosition);
        doc.text("Total", 95, yPosition);
        doc.text("Paid", 120, yPosition);
        doc.text("Due", 145, yPosition);
      ...
      const renderFooter = (pageNum: number) => {
        ...
        doc.text(
          "Generated by Kenya Trails Booking System",
          pageWidth / 2,
          pageHeight - 15,
          { align: "center" }
        );
      ...
      const renderSignatureLine = () => {
        ...
        doc.text("Authorized Signature", 20, pageHeight - 30);
      };
      ...
      bookings.forEach((booking, index) => {
        ...
        doc.text(booking.userName.slice(0, 20), 22, yPosition);
        doc.text(bookingDate, 65, yPosition);
        doc.text(`${booking.totalAmount.toLocaleString()}`, 95, yPosition);
        doc.text(`${booking.amountPaid.toLocaleString()}`, 120, yPosition);
        doc.text(`${booking.amountDue.toLocaleString()}`, 145, yPosition);
        ...
        doc.text(booking.paymentStatus.toUpperCase(), 170, yPosition);
      ...
      // Save file
      doc.save(
        `Kenya_Trails_${event.title.replace(/\s+/g, "_")}_Bookings_${
