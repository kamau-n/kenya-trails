    ...
    <div className="relative py-20 md:py-32 overflow-hidden rounded-3xl my-8">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
          Explore Kenya's <span className="text-green-400">Breathtaking</span>{" "}
          Landscapes
        </h1>
        <p className="text-xl md:text-2xl text-gray-200 mb-8 max-w-3xl mx-auto">
          Join group adventures to Kenya's most beautiful destinations. Book
          your spot or organize your own trip.
        </p>
