  ...
  const steps = [
    {
      ...
      description:
        "Browse through a variety of hiking and travel events across Kenya.",
    },
    {
      icon: <Calendar className="h-10 w-10 text-green-600" />,
      title: "Book Your Spot",
      description:
        "Reserve your place in upcoming adventures with just a few clicks.",
    },
    {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="md:text-lg text-sm text-gray-600 max-w-2xl mx-auto">
            Kenya Trails makes it easy to discover and join group adventures or
