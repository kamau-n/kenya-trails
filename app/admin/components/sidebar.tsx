...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <nav
        className={`fixed inset-y-0 left-0 z-[70] w-64 bg-white dark:bg-[#0F0F12] transform transition-transform duration-200 ease-in-out
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-1">
                  ...
                  <NavItem href="/admin/organization" icon={Folder}>
                    Organizations
                  </NavItem>
                  <NavItem href="/admin/promotions" icon={Building2}>
                    Promotions
                  </NavItem>
                  <NavItem href="/admin/feedback" icon={MessageCircle}>
                    Feedback
                  </NavItem>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-1">
                  ...
                  <NavItem href="/admin/operations" icon={Wallet2}>
                    Operations
                  </NavItem>
                </div>
              </div>
