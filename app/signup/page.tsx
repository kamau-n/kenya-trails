  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (user) {
        ...
        // Redirect based on parameters or user type
        if (redirectPath) {
    ...
    <div className="container mx-auto px-4 py-16 flex justify-center">
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription>Join Kenya Trails to discover and book exciting adventures</CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <div className="space-y-2">
                ...
                >
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="traveler">Book adventures as a traveler</Label>
                  </div>
                  <div className="flex items-center space-x-2">
