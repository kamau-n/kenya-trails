...
export default function EventPage({ params }) {
  ...
  const placeholderEvent = {
    ...
    description:
      "Join us for an unforgettable 3-day hiking adventure to Point Lenana on Mt. Kenya. Experience breathtaking views, diverse wildlife, and the achievement of reaching the third highest peak in Kenya. This trip is suitable for moderately fit hikers with some previous hiking experience.",
    location: "Mt. Kenya National Park",
    meetingPoint: "Naro Moru River Lodge, 7:00 AM",
    ...
    included: [
      "Professional guide",
      "Park entry fees",
      "Accommodation (2 nights in mountain huts)",
      "All meals during the hike",
      "Transport from Nairobi and back",
    ],
    notIncluded: ["Personal hiking gear", "Travel insurance", "Personal expenses", "Tips for guides and porters"],
    itinerary: [
      {
        day: "Day 1",
        title: "Nairobi to Mt. Kenya",
        description:
          "Early morning departure from Nairobi. Drive to Naro Moru gate. Begin hiking through the forest to Met Station Camp (3,050m).",
      },
      {
        day: "Day 2",
        title: "Ascent to Shipton's Camp",
        description: "Hike through the moorland to Shipton's Camp (4,200m). Acclimatization walk in the afternoon.",
      },
      {
        day: "Day 3",
        title: "Summit and Descent",
        description: "Early morning start for Point Lenana (4,985m). Descend to Met Station and drive back to Nairobi.",
      },
    ],
    requirements: [
    ...
    organizerId: "org123",
    organizerName: "Kenya Adventure Tours",
  }
              ...
              <div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    {organizer && organizer.bio && <p className="text-gray-600 mt-1">{organizer.bio}</p>}
                  </div>
                </div>
              </div>
            </TabsContent>
            ...
            <TabsContent value="itinerary" className="space-y-6">
              ...
              <div className="space-y-6">
                {event.itinerary?.map((day, index) => (
                  <div key={index} className="border-l-2 border-green-600 pl-4 pb-6">
        ...
        <div className="lg:col-span-1">
          {bookingSuccess ? (
            <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-6">
              ...
              <p className="text-green-700 mb-4">Your booking has been successfully confirmed.</p>
            ...
            <BookingForm event={event} onClose={() => setShowBookingForm(false)} onSuccess={handleBookingSuccess} />
          ) : (
            <div className="bg-white rounded-lg border border-gray-200 overflow-hidden sticky top-20">
              <div className="p-6 border-b border-gray-200">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <p className="text-2xl font-bold text-green-600">KSh {event.price.toLocaleString()}</p>
                    <p className="text-gray-600">per person</p>
                  </div>
                  <Badge className={event.availableSpaces > 0 ? "bg-green-600" : "bg-red-600"}>
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="flex items-center text-gray-700">
                    ...
                    <div>
                      ...
                      <p>
                        {event.availableSpaces} spots left out of {event.totalSpaces}
                      </p>
                    </div>
                  </div>
