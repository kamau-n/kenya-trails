    ...
    <div className="container mx-auto px-4">
      ...
      <section className="py-16 bg-green-50 rounded-xl my-16 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-6">Ready to explore Kenya's beautiful landscapes?</h2>
          <p className="text-lg mb-8">
            Join our community of adventure seekers and event organizers. Discover new places, meet new people, and
