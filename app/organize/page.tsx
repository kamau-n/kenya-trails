  ...
  const benefits = [
    {
      ...
      description:
        "Connect with adventure seekers across Kenya looking for their next experience.",
    },
    {
      icon: <Calendar className="h-10 w-10 text-green-600" />,
      title: "Easy Scheduling",
      description:
        "Create and manage your events with our intuitive scheduling tools.",
    },
    {
      icon: <CreditCard className="h-10 w-10 text-green-600" />,
      title: "Secure Payments",
      description:
        "Accept deposits or full payments through our secure payment system.",
    },
    {
      icon: <TrendingUp className="h-10 w-10 text-green-600" />,
      title: "Grow Your Business",
      description:
        "Expand your customer base and increase bookings for your travel experiences.",
    },
  ];
  ...
  const steps = [
    {
      ...
      description:
        "Create an account or switch your existing account to organizer mode.",
    },
    {
      number: "2",
      title: "Create Your First Event",
      description:
        "Add details, photos, itinerary, and set your pricing and available spaces.",
    },
    {
      number: "3",
      title: "Manage Bookings",
      description:
        "Track reservations, confirm payments, and communicate with travelers.",
    },
    {
      number: "4",
      title: "Host Amazing Experiences",
      description:
        "Lead your events and create unforgettable memories for your guests.",
    },
  ];
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Join our community of passionate guides and event organizers to
            share your love for Kenya's natural beauty.
          </p>
        </div>
      ...
      <section id="how-it-works" className="py-16 bg-gray-50 rounded-xl">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Getting started as an organizer is simple. Follow these steps to
              begin hosting your own events.
            </p>
          </div>
      ...
      <section className="py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Our platform provides everything you need to create, manage, and
            grow your travel events.
          </p>
        </div>
          ...
          <CardContent className="pt-8 pb-8">
            <div className="text-center">
              ...
              <p className="text-xl mb-8 max-w-2xl mx-auto">
                Start organizing your own travel and hiking events today and
                join our community of passionate guides.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button
                  size="lg"
                ...
                {!user && (
                  <Button
                    ...
                    <Link href="/signup?userType=organizer">
      ...
      <section className="py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Get answers to common questions about organizing events on Kenya
            Trails.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-gray-600">
                Payments are processed through our platform and transferred to
                your preferred payment method (M-Pesa or bank account) within 48
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-gray-600">
                You can cancel an event up to 7 days before the start date.
                Cancellations closer to the event date may affect your organizer
                rating.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-gray-600">
                While not always required, we recommend having relevant
                certifications for your activity type. For certain activities
                like mountain climbing, proper certification is mandatory.
              </p>
            </CardContent>
          </Card>
        </div>
