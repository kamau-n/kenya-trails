	...
	const downloadReceipt = (withdrawal: withdrawal) => {
		try {
			...
			if (withdrawal.accountDetails) {
				...
				doc.text(
					`Bank: ${withdrawal.accountDetails.bankName}`,
					30,
					130
				);
				doc.text(
				...
				doc.text(
					`Name: ${withdrawal.accountDetails.accountName}`,
					30,
					150
				);
			}
						...
						<div className="p-6">
							...
							<div className="space-y-6">
									...
									<div>
										...
										>
											...
											{selectedWithdrawal?.status
												?.charAt(0)
												.toUpperCase() +
												selectedWithdrawal.status.slice(
													1
												)}
										</span>
									</div>
								...
								<div className="flex gap-3 pt-4 border-t">
									...
									<button
										onClick={() =>
											downloadReceipt(selectedWithdrawal)
										}
