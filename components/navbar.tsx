...
import { Menu, User, LogOut, PlusCircle, Calendar, Map } from "lucide-react"
...
export default function Navbar() {
  ...
  const signOut = auth?.signOut // Safely access signOut method
        ...
        <div className="flex h-16 items-center justify-between">
          <div className="flex items-center">
            <Link href="/" className="flex items-center">
              ...
              <span className="text-xl font-bold text-green-600">Kenya Trails</span>
            </Link>
